...
const routes: Routes = [
  ...
  { path: 'appointments', component: AppointmentComponent,canActivate:[AdminauthguardService] }, // Adjust if necessary
  { path: 'create-appointment', component: CreateAppointmentComponent,canActivate:[AdminauthguardService] },
  // Add a route for appointmentlist if needed
  { path: 'appointmentlist', component: AppointmentComponent,canActivate:[AdminauthguardService] }, // If you're using the same component
  {
